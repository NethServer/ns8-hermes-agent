...
- `containers/hermes/Containerfile`: Hermes wrapper image built from `docker.io/nousresearch/hermes-agent:v2026.7.7.2` (Hermes release `v0.18.2`) that keeps the upstream `/init` + s6-overlay entrypoint and only layers NS8-specific packages and web assets.
