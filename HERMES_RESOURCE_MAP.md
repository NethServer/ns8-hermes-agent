...
*Last verified: 2026-07-09.* Hermes Agent is the open-source, self-improving agent by Nous Research, with official docs at `hermes-agent.nousresearch.com/docs`, the main codebase in `NousResearch/hermes-agent`, and the current latest release listed as `v0.18.2` (`v2026.7.7.2`). ([hermes-agent.nousresearch.com][1])
...
* [GitHub Releases](https://github.com/NousResearch/hermes-agent/releases) — primary source for “what changed recently” and version-by-version trend tracking. Latest visible release is `v0.18.2` (`v2026.7.7.2`). ([GitHub][4])
